...
/*
  ...
  TODO[wire]: on submit, subscribe `email` to the Kit EEC sequence (front-end confirm is a mock for now).
*/
export default function OptinTerminal() {
  ...
  function submit(e: React.FormEvent) {
    ...
    if (!armed) return;
    setSent(true);
    // TODO[wire]: subscribe `email` to Kit EEC "5 Steps to Becoming AI Native".
  }
  ...
  return (
    <form onSubmit={submit} className="metal-housing w-full max-w-[600px] p-3">
      {sent ? (
        <div className="metal-well p-1.5">
          <div className="mini-crt px-4 py-5 rounded-md">
            <p className="font-mono text-[13px]" style={{ color: "var(--sig-green)" }}>
              &gt; Transmitted. Check your inbox.
            </p>
          </div>
        </div>
      ) : (
          ...
          <div className="metal-well flex flex-col items-center justify-center gap-1.5 px-3 py-3">
            <div className="cover-wrap relative">
              ...
              >
                ...
                <span className="physical-btn-front font-mono text-[10px] font-bold tracking-[0.1em]">GO</span>
              </button>
      ...
      <div className="flex items-center justify-between mt-3 px-1">
        <span className="font-mono text-[8px] tracking-[0.16em] uppercase text-ink/35">For AI-native use only</span>
