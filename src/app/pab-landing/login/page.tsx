...
function LoginForm() {
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    if (pw === 'white liquor') {
      document.cookie = 'pab_auth=granted; path=/; max-age=2592000; samesite=strict';
      const from = params.get('from') ?? '/pab-landing';
      router.push(from);
    } else {
      setError(true);
      setPw('');
...
export default function PabLandingLogin() {
  return (
